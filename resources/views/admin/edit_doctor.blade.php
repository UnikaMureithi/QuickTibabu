  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="container" align="center" style="padding: 100px">
        ...
        <form action="{{ url('update_doctor',$data->doctor_id) }}" method="POST" enctype="multipart/form-data">
          ...
          <div style="padding: 15px;">
            ...
            <input type="text" name="mobile_number" value="{{ $data->mobile_number }}">
          </div>

          <div style="padding: 15px;">
            <label>Doctor Speciality</label>
            <input type="text" name="doctor_type" value="{{ $data->doctor_type }}">
          </div>

          <div style="padding: 15px;">
            <label>OLD Doctor Image</label>
            <img height="150" width="150" src="doctorimage/{{ $data->doctor_image }}">
          </div>
